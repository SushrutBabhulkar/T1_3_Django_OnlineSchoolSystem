...
def homework(request):
    students = Students.objects.filter(course_id=Courses.id)
    student_homework = Homework.objects.filter(course_name=Courses.course_name,subject_name=Subjects.subject_name)
    context = {
